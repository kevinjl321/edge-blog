        ...
        <SectionContainer>
          <main>
            <article className="py-16">
              <Head>
                <title>{meta.title} – Project Edge</title>
                <meta name="twitter:site" content="@tailwindcss" />
                <meta name="twitter:creator" content="@tailwindcss" />
                <meta name="twitter:title" content={`${meta.title} – Project Edge`} />
                ...
                {meta.image ? (
                  <>
                    ...
                    <meta
                      name="twitter:image"
                      content={`https://blog.project-edge.kevinjl321.vercel.app${meta.image}`}
                    />
                  </>
                ) : (
                  <>
                    ...
                    <meta
                      name="twitter:image"
                      content={`https://blog.project-edge.kevinjl321.vercel.app${smallCard}`}
                    />
                  </>
                )}
                <meta
                  property="og:url"
                  content={`https://blog.project-edge.kevinjl321.vercel.app${router.pathname}`}
                />
                <meta property="og:type" content="article" />
                <meta property="og:title" content={`${meta.title} – Project Edge`} />
                <meta property="og:description" content={meta.description} />
                <meta property="og:image" content={`https://blog.project-edge.kevinjl321.vercel.app${meta.image}`} />
        ...
        <main>
          <article className="xl:divide-y xl:divide-gray-200">
            <Head>
              ...
              <meta name="twitter:title" content={`${meta.title} – Project Edge`} />
              <meta name="twitter:description" content={meta.description} />
              <meta name="twitter:image" content={`https://blog.project-edge.kevinjl321.vercel.app${meta.image}`} />
              <meta property="og:url" content={`https://blog.project-edge.kevinjl321.vercel.app${router.pathname}`} />
              <meta property="og:type" content="article" />
              <meta property="og:title" content={`${meta.title} – Project Edge`} />
              <meta property="og:description" content={meta.description} />
              <meta property="og:image" content={`https://blog.project-edge.kevinjl321.vercel.app${meta.image}`} />
